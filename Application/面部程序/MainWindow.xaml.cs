...
namespace Kinect2FaceHD_NET
{
    public partial class MainWindow : Window
    {
        ...
        {
            if (CurrentPage != 0 && CurrentPage != 1 && CurrentPage != 19 && CurrentPage != 20)
            {
        ...
        public void NextPage(int num)
        {
            if (num == 25)
            {
                SetCurrentPage(this.retryVideoPage);
            }
            else
        ...
        public void SetCurrentPage(int num)
        {
            switch (num)
            {
                case 1: CurrentPage = num; ContentControl.Content = new WpfSV.MicroPhoneTest(CurrentPage); break;
                case 2: CurrentPage = num; ContentControl.Content = new VideoGuide2.VideoGuide(CurrentPage); break;
                case 3: CurrentPage = num; ContentControl.Content = new EmotionTest2.EmotionTest(CurrentPage, "" + Disk + ":\\VoiceData\\" + UserId, video1,true); break;
                case 4: CurrentPage = num; refreshShow(); this.show.SetPage(CurrentPage); ContentControl.Content = this.show; this.SetCanShowFace(true); this.SensorOpen(); break;
                case 5: CurrentPage = num; ContentControl.Content = new VideoPlayer.VideoPlayer(CurrentPage, FileName[1, 1]); break;
                case 6: CurrentPage = num; ContentControl.Content = new EmotionTest2.EmotionTest(CurrentPage, "" + Disk + ":\\VoiceData\\" + UserId, video1, false); break;
                case 7: CurrentPage = num; ContentControl.Content = new ShowPicture2.ShowPicture(CurrentPage, 1, 1, QuestionPicture[1], "" + Disk + ":\\VoiceData\\" + UserId, true,true); break;
                case 8: CurrentPage = num; this.saving = new Saving2.Saving(CurrentPage); ContentControl.Content = this.saving; this.SetRecordSwitch(false); Thread t = new Thread(delegate() { save(currentVideo); }); t.Start(); break;
                //case 9: CurrentPage = num; ContentControl.Content = new Relex2.Relex(CurrentPage,3,false); break;
                ...
                case 10: CurrentPage = num; ContentControl.Content = new VideoPlayer.VideoPlayer(CurrentPage, FileName[2, 1]); break;
                case 11: CurrentPage = num; ContentControl.Content = new EmotionTest2.EmotionTest(CurrentPage, "" + Disk + ":\\VoiceData\\" + UserId, video2, true); break;
                case 12: CurrentPage = num; ContentControl.Content = new ShowPicture2.ShowPicture(CurrentPage, 1, 1, QuestionPicture[2], "" + Disk + ":\\VoiceData\\" + UserId, true, true); break;
                case 13: CurrentPage = num; this.saving = new Saving2.Saving(CurrentPage); ContentControl.Content = this.saving; this.SetRecordSwitch(false); t = new Thread(delegate() { save(currentVideo); }); t.Start(); break;
                //case 15: CurrentPage = num; ContentControl.Content = new Relex2.Relex(CurrentPage,3,false); break;


                case 14: CurrentPage = num; refreshShow(); this.show.SetPage(CurrentPage); ContentControl.Content = this.show; this.SetCanShowFace(true); this.SetRecordSwitch(true); break;
                case 15: CurrentPage = num; ContentControl.Content = new VideoPlayer.VideoPlayer(CurrentPage, FileName[3, 1]); break;
                case 16: CurrentPage = num; ContentControl.Content = new EmotionTest2.EmotionTest(CurrentPage, "" + Disk + ":\\VoiceData\\" + UserId, video3, true); break;
                case 17: CurrentPage = num; ContentControl.Content = new ShowPicture2.ShowPicture(CurrentPage, 1, 1, QuestionPicture[3], "" + Disk + ":\\VoiceData\\" + UserId, true, true); break;
                case 18: CurrentPage = num; this.saving = new Saving2.Saving(CurrentPage); ContentControl.Content = this.saving; this.SensorClose(); t = new Thread(delegate() { save(currentVideo); }); t.Start(); break;
                case 19: CurrentPage = num; ContentControl.Content = new End2.End(CurrentPage); break;
                case 20: CurrentPage = num; ContentControl.Content = new Relex2.Relex(CurrentPage, 60,true); break;
