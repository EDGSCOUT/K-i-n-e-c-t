...
namespace WpfSV
{
    class AudioFrame
    {
        ...
        public void RenderTimeDomain(ref PictureBox pictureBox)
        {
            ...
            double yScaleLeft = 0.5 * (leftBottom - leftTop) / 32768  * 40;  // a 16 bit sample has values from -32768 to 32767
            ...
            double yScaleRight = 0.5 * (rightBottom - rightTop) / 32768 * 40;  // a 16 bit sample has values from -32768 to 32767
